        ...
        <div class="container-fluid">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3"><img src="../imagenes/medalfaLogo.png" width=90 alt="Logo"></div> 
                </div>
                ...
                <form class="form-horizontal" role="form" name="formulario_receta" id="formulario_receta" method="get" action="../Receta">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <label for="uni_ate" class="col-sm-2 control-label"> Unidad de Salud:</label>
                                <div class="col-md-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <input name="folio" type="text" class="form-control" id="folio" placeholder="Folio"  value="<%=folio_rec%>">
                                    </div>
                                </div>
                            <br />
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="medico_jq" name="medico_jq" placeholder="Médico" onkeypress="return tabular(event, this);" autofocus value="<%=medico%>">
                                </div>
                                <div class="col-sm-2">
                                    <input type="hidden" id="m3" name="m3" value="si">
                                    <button class="btn btn-block btn-primary" name="mostrar3" id="mostrar3">Mostrar</button>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="row">
                                <label for="medico" class="col-sm-1 control-label"> Médico:</label>
                                <div class="col-md-4">
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <label for="bus_pac" class="col-sm-2 control-label">
                                    <button type="button" class="btn btn-default" data-placement="left" data-toggle="tooltip" title="Buscar Paciente por folio de paciente" id="bus_pac"><span class="glyphicon glyphicon-search"></span></button>
                                    No. Paciente
                                </label>
                                <div class="col-sm-2">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <a class="btn btn-success" onclick="window.open('../farmacia/catalogoCIE.jsp', '', 'width=1200,height=800,left=50,top=50,toolbar=no')"><span class="glyphicon glyphicon-list"></span></a>
                            </div>
                        </div>
                        <br/>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <button class="btn btn-block btn-primary" id="btn_capturarManual" name="btn_capturarManual" type="button">Capturar</button>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            <div class="row" id="tablaBotones">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <button class="btn btn-block btn-primary" name="btn_nueva" value="3" id="btn_clave">Guardar Receta</button>
                                </div>
                                <%
                                    /*  int ban_imp = 0;
                                     try {
