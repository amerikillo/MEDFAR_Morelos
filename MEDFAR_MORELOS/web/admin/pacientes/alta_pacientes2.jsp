                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input class="form-control" data-date-format="yyyy/mm/dd" id="fec_nac" name="fec_nac"/>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="direc" name="direc" placeholder="" onkeyup="upperCase(this.id)"  value=""/>
                                </div>
                            </div><br/>
                            <div class="row">
                            ...
                            <br />
                            <h4><label id="datosp" class="col-sm-2 control-label">Datos de la Poliza</label></h4>
                            <br />
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <!--input type="text" class="form-control" id="ini_vig"  maxlength="10" data-date-format="dd/mm/yyyy" name="ini_vig"  placeholder=""  value="" onkeypress="
                                            ...
                                            anade(this);
                                            return isNumberKey(event, this);"/-->
                                    <input type="text" data-date-format="yyyy/mm/dd" class="form-control" id="ini_vig" name="ini_vig"/>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <!--input type="text" class="form-control" maxlength="10" id="fin_vig"  data-date-format="dd/mm/yyyy" name="fin_vig"  placeholder=""  value="" onkeypress="
                                            ...
                                            anade(this);
                                            return isNumberKey(event, this);"/-->
                                    <input type="text" data-date-format="yyyy/mm/dd" class="form-control" id="fin_vig" name="fin_vig"/>
                                </div>
                            </div>
                            <br />
                            <div class="row">
