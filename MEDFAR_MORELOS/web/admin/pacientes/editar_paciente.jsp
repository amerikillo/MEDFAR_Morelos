...
<%
    ...
    String id = "", num_afi = "", tip_cob = "", ape_pat = "", ape_mat = "", nom_pac = "", fec_nac = "", sexo = "", expediente = "", ini_vig = "", fin_vig = "", f_status = "", direc = "";
    try {
    ...
    try {
        con.conectar();
        rset = con.consulta("SELECT num_afi,tip_cob,ape_pat,ape_mat,nom_pac,DATE_FORMAT(fec_nac,'%Y/%m/%d'),sexo,expediente,DATE_FORMAT(ini_vig,'%Y/%m/%d') AS ini_vig,DATE_FORMAT(fin_vig,'%Y/%m/%d') AS fin_vig,f_status,direccion FROM pacientes WHERE id_pac='" + id + "'");
        if (rset.next()) {
                    ...
                    <form class="form-horizontal" role="form" name="formulario_pacientes" id="formulario_pacientes" method="get" action="../../ModiPacientes">
                        <div class="panel-body">                                                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="fec_nac" name="fec_nac" placeholder="" data-date-format="yyyy/mm/dd"  value="<%=fec_nac%>"/>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="direc" name="direc" placeholder="" onkeyup="upperCase(this.id)"  value="<%=direc%>"/>
                                </div>
                            </div><br/>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="ini_vig" name="ini_vig" placeholder="" data-date-format="yyyy/mm/dd"  value="<%=ini_vig%>"/>
                                </div>
                                <label for="fin_vig" class="col-sm-2 control-label">Fin de Vigencia</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="fin_vig" data-date-format="yyyy/mm/dd" name="fin_vig" placeholder=""  value="<%=fin_vig%>"/>
                                </div>
                            </div>
                            <br />
                            <div class="row">
        ...
        <script>
                                        ...
                                        $(document).ready(function() {
                                            ...
                                            $('#Guardar').click(function() {
                                                var RegExPattern = /^\d{4,4}\/\d{1,2}\/\d{1,2}$/;
                                                ...
                                                if (no_afi === "" || tip_cob === "" || ape_pat === "" || ape_mat === "" || nombre === "" || fec_nac === "" || sexo === "" || no_exp === "" || ini_vig === "" || fin_vig === "" || direc === "") {
                                                ...
                                                if ((fec_nac.match(RegExPattern)) && (fec_nac != '')) {
                                                    ...
                                                    alert("Fecha de nacimiento Incorrecta, verifique.");
                                                    return false;
                                                }
                                                ...
                                                function devuelveFolio(data) {
                                                    ...
                                                    for (var i = 0; i < json.length; i++) {
                                                        ...
                                                        if (ban == 1) {
                                                            ...
                                                            $('#ini_vig').val("");
                                                            $('#fin_vig').val("");
            <%if (DesdeFarm.equals("si")) {%>
                                                            self.location = 'pacientes1.jsp';
            <%} else {%>
